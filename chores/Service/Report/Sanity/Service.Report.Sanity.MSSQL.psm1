# Sanity Report, Per Server, For MSSQL Instances with Bar Graph
...
function StepProcess {
    ...
    $SaveHtml = Join-Path  $GLOBAL:_PWR['STORAGEDIR'] 'MSSQL_Sanity.html'
    $SaveGraph = Join-Path  $GLOBAL:_PWR['STORAGEDIR'] 'SanitySQL.png'
    ...
    If(-not($Script:Info.ContainsKey('Title'))) {
        $Script:Info['Title'] = "SQL Server Sanity Check"
    }
